...
func getPowerup():
	...
	if randomizer > 42:return powerup.coin.instantiate()
	elif randomizer > 48: return powerup.purse.instantiate()
	...
	elif randomizer > 6.6: return powerup.engine.instantiate()
	elif randomizer > 3.3: return powerup.steering.instantiate()		
